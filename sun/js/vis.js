document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener('resize', () => {
    ...
    g_skydome.mat.uniforms.offsetWidth.value = g_container.offsetWidth;
    g_skydome.mat.uniforms.offsetHeight.value = g_container.offsetHeight;
  ...
  function initScene(canvasDiv) {
    ...
    g_camera = new THREE.PerspectiveCamera(65, width / height, 6.0, 12000.0)
  ...
  function animationLoop() {
    ...
    g_skydome.mat.uniforms.cloudMove.value = Math.cos(g_time * 0.00001);
    g_skydome.mat.uniforms.time.value = d.getTime();
